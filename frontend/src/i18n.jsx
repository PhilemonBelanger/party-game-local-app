...
const dict = {
  en: {
    ...
    'home.pickBuddy': 'Pick your buddy',
    'home.hostTitle': 'Hosting on the TV?',
    'host.scanHop': 'Scan to hop in!',
    'host.startGo': "Let's go! ▸",
    'host.waitingCrowd': 'Waiting for friends to hop in…',
    ...
    'fibbage.suggestionsLeft': ({ used, max }) => `Suggestions used: ${used} / ${max} (whole game)`,
    'fibbage.thatsTheTruth': ({ pts }) => `That's the real answer — congrats! 🎉 (+${pts} bonus) But enter something else to fool everyone!`,
    ...
    'fibbage.pickTrue': 'Pick the real answer — and 👍 a different favorite',
    'fibbage.pickBothHint': 'Pick one answer to vote and 👍 a different one.',
    'fibbage.yourLie': '(your lie)',
    'fibbage.thumbHint': 'Thumbs up a different answer',
    ...
    'fibbage.bdGuessed': ({ pts }) => `🎯 You found the truth (+${pts})`,
    'fibbage.bdFooled': ({ n, pts }) => `🤥 You fooled ${n} ${n === 1 ? 'player' : 'players'} (+${n * pts})`,
    'fibbage.bdThumbs': ({ pts }) => `👍 Most thumbs-up (+${pts})`,
    'fibbage.bdTriedTruth': ({ pts }) => `🎉 You typed the real answer (+${pts})`,
    'fibbage.triedTruthReveal': ({ names, pts }) => `🎉 Typed the real answer (+${pts}): ${names}`,
  ...
  fr: {
    ...
    'home.pickBuddy': 'Choisis ton copain',
    'home.hostTitle': 'Tu animes sur la télé ?',
    'host.scanHop': 'Scanne pour jouer !',
    'host.startGo': "C'est parti ! ▸",
    'host.waitingCrowd': 'On attend les amis…',
    ...
    'draw.fill': 'Remplir (pot de peinture)',
    'draw.eraser': 'Gomme',
    'draw.undo': 'Annuler',
    'draw.clear': 'Effacer',
    ...
    'fibbage.suggestionsLeft': ({ used, max }) => `Suggestions utilisées : ${used} / ${max} (toute la partie)`,
    'fibbage.thatsTheTruth': ({ pts }) => `C'est la vraie réponse — bravo ! 🎉 (+${pts} bonus) Mais entrez autre chose pour piéger les autres !`,
    ...
    'fibbage.pickTrue': 'Choisissez la vraie réponse — et 👍 un autre coup de cœur',
    'fibbage.pickBothHint': 'Votez pour une réponse et 👍 en aimez une autre.',
    'fibbage.yourLie': '(votre bobard)',
    'fibbage.thumbHint': "Pouce levé sur une autre réponse",
    ...
    'fibbage.bdGuessed': ({ pts }) => `🎯 Vous avez trouvé la vérité (+${pts})`,
    'fibbage.bdFooled': ({ n, pts }) => `🤥 Vous avez piégé ${n} joueur${n === 1 ? '' : 's'} (+${n * pts})`,
    'fibbage.bdThumbs': ({ pts }) => `👍 Le plus de pouces levés (+${pts})`,
    'fibbage.bdTriedTruth': ({ pts }) => `🎉 Vous avez tapé la vraie réponse (+${pts})`,
    'fibbage.triedTruthReveal': ({ names, pts }) => `🎉 A tapé la vraie réponse (+${pts}) : ${names}`,
