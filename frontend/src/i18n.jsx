...
const dict = {
  en: {
    ...
    'fibbage.thatsTheTruth': "That's the real answer — congrats! 🎉 (+100 bonus) But enter something else to fool everyone!",
    ...
    'fibbage.bdTriedTruth': '🎉 You typed the real answer (+100)',
    'fibbage.triedTruthReveal': ({ names }) => `🎉 Typed the real answer (+100): ${names}`,
  ...
  fr: {
    ...
    'fibbage.thatsTheTruth': "C'est la vraie réponse — bravo ! 🎉 (+100 bonus) Mais entrez autre chose pour piéger les autres !",
    ...
    'fibbage.bdTriedTruth': '🎉 Vous avez tapé la vraie réponse (+100)',
    'fibbage.triedTruthReveal': ({ names }) => `🎉 A tapé la vraie réponse (+100) : ${names}`,
